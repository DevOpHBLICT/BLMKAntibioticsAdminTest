...

{
...

    {
        ...
        if (Area.Text == "") { ok = 1; Error_Label.Visible = true; Error_Label.Text = Error_Label.Text+ "Front Page,"; }
...

        {
            ...
            sql = sql + "insert into frontpages(user_id,UpdatedAt,Deleted,Complete,Description,Area,Area_Image,Area_Image_String)";
