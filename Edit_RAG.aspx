<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Sites.Master" AutoEventWireup="true" CodeFile="Edit_RAG.aspx.cs" validateRequest="false" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
           ...
           <asp:Label ID="Label1" runat="server" Text="Edit Drug/Colour" Font-Size="X-Large" Font-Underline="True" Font-Bold="True"></asp:Label>
...
<asp:Label ID="Error_Label" runat="server" ForeColor="Red" Visible="True"></asp:Label>
 ...
 <div class="form-group" > <asp:Label ID="Label8" runat="server" Text="Drug:" Font-Bold="True" ></asp:Label></div>
