<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Sites.master" AutoEventWireup="true" CodeFile="FrontPage.aspx.cs" Inherits="Account_Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script runat="server">
        ...
        <asp:Label ID="Label1" runat="server" Text="Front Page" Font-Size="X-Large" Font-Underline="True" Font-Bold="True"></asp:Label>
    <br />
    <br />
    <br />

        <asp:Button style="color:white;Background-Color: green" CssClass="btn btn-default" ID="lbtnAdd" runat="server" onclick="lbtnAdd_Click" Text="Add New Front Page"></asp:Button>
