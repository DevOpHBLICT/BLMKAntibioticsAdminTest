<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Sites.master" AutoEventWireup="true" CodeFile="Config.aspx.cs" Inherits="Account_Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script runat="server">
        ...
        <span style="font-weight: bold; font-size: x-large; text-decoration: underline">Config</span><br />
    <br />
    <br />

        <asp:Button style="color:white;Background-Color: green" CssClass="btn btn-default" ID="lbtnAdd" runat="server" onclick="lbtnAdd_Click" Text="Add Config"></asp:Button>
    ...
    &nbsp;<br />
                ...
                <asp:GridView ID="GridView1" width="1200px" runat="server" AutoGenerateColumns="False" OnRowDataBound="OnRowDataBound"  CellPadding="4" ForeColor="#333333" 
                    ...
                    <Columns>
                         ...
                         <asp:BoundField DataField="Value" HeaderText="Value" SortExpression="Config" />
