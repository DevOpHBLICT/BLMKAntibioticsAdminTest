...

{
...

    {
        ...
        string ss = "";
         ...
         if (Description.SelectedValue == "") { ok = 1; Error_Label.Visible = true; Error_Label.Text = Error_Label.Text + "Description,"; }
...

        {
            ...
            sql = sql + "insert into RAGs(UpdatedAt,Deleted,Complete,Description,Area)";
