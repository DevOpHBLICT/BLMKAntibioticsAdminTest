<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Sites.Master" AutoEventWireup="true" CodeFile="Edit_Disclaimer.aspx.cs" validateRequest="false" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
           ...
           <asp:Label ID="Label1" runat="server" Text="Edit Disclaimer" Font-Size="X-Large" Font-Underline="True" Font-Bold="True"></asp:Label>
...
SelectCommand="SELECT * FROM [Disclaimers]" OldValuesParameterFormatString="original_{0}" >
</asp:SqlDataSource>
