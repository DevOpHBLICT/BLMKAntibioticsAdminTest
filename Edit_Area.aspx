<%@ Page Title="Home Page" Language="C#" MasterPageFile="~/Sites.Master" AutoEventWireup="true" CodeFile="Edit_Area.aspx.cs" validateRequest="false" Inherits="_Default" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
           ...
           <asp:Label ID="Label1" runat="server" Text="Edit Area" Font-Size="X-Large" Font-Underline="True" Font-Bold="True"></asp:Label>
...
<div class="form-group" >     
    <strong>     
    <br />
    <b>SortOrder:</b></strong>
    <asp:TextBox  AutoCompleteType="Disabled" runat="server" class="form-control" type = "text" width="200px" id = "SortOrder"></asp:TextBox> 
    <br />
