<%@ Page Title="Home Page" validateRequest="false" Language="C#" MasterPageFile="~/Sites.Master" AutoEventWireup="true" CodeFile="Create_Area.aspx.cs" Inherits="_Default" %>

 

<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">

           <asp:Label ID="Label1" runat="server" Text="Create Area" Font-Size="X-Large" Font-Underline="True" Font-Bold="True"></asp:Label>
...
<div class="form-group"> <asp:Label ID="Label2" runat="server" Text="Area:" Font-Bold="True" ></asp:Label><asp:TextBox AutoCompleteType="Disabled" runat="server" class="form-control" type = "text" id = "Area" Width="1000px"  Font-Bold="False"></asp:TextBox> </div>
