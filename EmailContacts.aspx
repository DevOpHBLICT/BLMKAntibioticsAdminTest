<%@ Page Title="Manage Account" Language="C#" MasterPageFile="~/Sites.master" AutoEventWireup="true" CodeFile="EmailContacts.aspx.cs" Inherits="Account_Manage" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    ...
    <script runat="server">
        ...
        <span style="font-weight: bold; font-size: x-large; text-decoration: underline">ContactDetails</span><br />
    <br />
    <br />

        <asp:Button style="color:white;Background-Color: green" CssClass="btn btn-default" ID="lbtnAdd" runat="server" onclick="lbtnAdd_Click" Text="Add ContactDetails"></asp:Button>
